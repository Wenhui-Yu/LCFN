...
FREQUENCY_USER = {'Amazon': 128, 'KuaiRand': 128}[DATASET]
FREQUENCY_ITEM = {'Amazon': 128, 'KuaiRand': 128}[DATASET]
LAYER = 1
...
all_para = {'GPU_INDEX': GPU_INDEX, 'DATASET': DATASET, 'MODEL': MODEL, 'LR': LR, 'LAMDA': LAMDA, 'EMB_DIM': EMB_DIM,
            ...
            'FREQUENCY_USER': FREQUENCY_USER, 'FREQUENCY_ITEM': FREQUENCY_ITEM, 'LOSS_FUNCTION': LOSS_FUNCTION,
            'OPTIMIZER': OPTIMIZER, 'SAMPLER': SAMPLER, 'AUX_LOSS_WEIGHT': AUX_LOSS_WEIGHT}
