...
import numpy as np
import random as rd
from package.utils.dense2sparse import propagation_matrix
...
def read_all_data(all_para):
    ...
    elif all_para['MODEL'] == 'LightGCN': sparse_propagation_matrix = propagation_matrix(train_data_interaction, user_num, item_num, 'sym_norm')
