...
from package.models.model_MF import model_MF
from package.models.model_NCF import model_NCF
from package.models.model_SCF import model_SCF
from package.models.model_LightGCN import model_LightGCN
from package.models.model_LGCN import model_LGCN
from package.utils.test_model import test_model
from package.utils.print_save import print_value, save_value
...
def train_model(para, data, path_excel):
    ...
    if para["MODEL"] == 'SCF': model = model_SCF(data=data, para=para)
    ...
    for epoch in range(para["N_EPOCH"]):
        for batch_num in range(len(batches) - 1):
            ...
            for sample in range(batches[batch_num], batches[batch_num + 1]):
                ...
                sample_num = 0
                while sample_num < (para["SAMPLE_RATE"] if para["MODEL"] == 'LGCN' else 1):
